...
import { newTraceId, traceStorage, type TraceContext } from '../trace';
import { getLogger } from '../logger';

// eslint-disable-next-line @typescript-eslint/no-explicit-any
export async function requestLoggingPlugin(app: FastifyInstance<any, any, any, any>): Promise<void> {
